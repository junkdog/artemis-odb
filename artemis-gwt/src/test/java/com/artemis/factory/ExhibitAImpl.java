...
public class ExhibitAImpl implements ExhibitA {
	// default fields
	private World world;
	...
	public ExhibitAImpl(World world) {
		this.world = world;
		world.inject(this);
	...
	@Override
	public ExhibitA hitPoints(int current) {
		if (_sealed) {
	...
	@Override
	public ExhibitA position(float x, float y) {
	...
	@Override
	public ExhibitA velocity(float x, float y) {
	...
	@Override
	public ExhibitA velocity(float x) {
		_id_velocity_x_ = true;
		_velocity_x = x;
		return this;
	}
	@Override
	public ExhibitA asset(java.lang.String path) {
		_id_asset_path_ = true;
		_asset_path = path;
		return this;
	}
	@Override
	public ExhibitA culled(boolean culled) {
		_id_culled_culled_ = true;
		_cullible_culled = culled;
		return this;
	}
	@Override
	public ExhibitA pos(float x, float y) {
		_id_pos_x_y_ = true;
		_complex_x = x;
		_complex_y = y;
		return this;
	...
	@Override
	public ExhibitA hoho(float x, float y) {
		_id_hoho_x_y_ = true;
		_complex_x = x;
		_complex_y = y;
		return this;
