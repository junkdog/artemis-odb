...
#### Gradle
```groovy
  dependencies { compile "net.onedaybeard.artemis:artemis-odb:0.7.2" }
```

#### Manual Download

 - [Main library](http://repo1.maven.org/maven2/net/onedaybeard/artemis/artemis-odb/0.7.2/) 
 - [Command-line tool](http://repo1.maven.org/maven2/net/onedaybeard/artemis/artemis-odb-cli/0.7.2/)
