 ...
 * @author Arni Arent
 */
public class TagManager<T extends Entity> extends CosplayBaseSystem<T> {

	/** Tags mapped to entities. */
	private final Map<String, T> entitiesByTag;
	/** Tagged entities mapped to tags. */
	private final Map<T, String> tagsByEntity;
	 ...
	 */
	public TagManager() {
		entitiesByTag = new HashMap<String, T>();
		tagsByEntity = new HashMap<T, String>();
