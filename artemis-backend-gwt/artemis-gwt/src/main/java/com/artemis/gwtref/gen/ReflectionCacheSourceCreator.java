...
public class ReflectionCacheSourceCreator {
    ...
    final int part;
    final ReflectionCacheTypeReport report;
    SourceWriter sw;
    ...
    public ReflectionCacheSourceCreator(TreeLogger logger, GeneratorContext context, JClassType type, int part) {
        ...
        this.part = part;
        this.report = new ReflectionCacheTypeReport(logger, this.simpleName);
    ...
    private void generateLookups() {
        ...
        try {
            ConfigurationProperty prop = context.getPropertyOracle().getConfigurationProperty("artemis.reflect.include");
        ...
        report.report();
        logger.log(Type.INFO, types.size() + " types reflected for " + simpleName);
    }
