...
public class ShipShortWireImpl implements ShipShortWire {
	// default fields
	private World world;
	...
	public ShipShortWireImpl(World world) {
		this.world = world;
		world.inject(this);
	...
	@Override
	public ShipShortWire hitPoints(int current) {
		if (_sealed) {
	...
	@Override
	public ShipShortWire position(float x, float y) {
	...
	@Override
	public ShipShortWire velocity(float x, float y) {
	...
	@Override
	public ShipShortWire asset(java.lang.String path) {
		_id_asset_path_ = true;
		_asset_path = path;
		return this;
	}
	@Override
	public ShipShortWire size(float width, float height) {
