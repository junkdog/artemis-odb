...
public class WireTest {
    ...
    public void inject_custom_type() {
        ...
        EntityWorld w = new EntityWorld(config);
    ...
    public void inject_wired_world_and_notwired_world_into_everything() {
        EntityWorld wiredWorld = new EntityWorld(new WorldConfiguration());
        EntityWorld setWorld = new EntityWorld(new WorldConfiguration());
        EntityWorld world = new EntityWorld(new WorldConfiguration()
                .register(wiredWorld));
    ...
    public void try_inject_on_wired_object_mirrors_inject_behaviour() {
        EntityWorld world = new EntityWorld(new WorldConfiguration().register("world").setSystem(TagManager.class));
        SomeThing st = new SomeThing();
    ...
    public void When_explicit_inject_pojo_into_wire_injectinherited_false_annotated_pojo_Then_should_NOT_inject_into_superclass_fields() {
        ...
        EntityWorld w = new EntityWorld(new WorldConfiguration().register(new InjectedPojo()));
        w.inject(pojo, true);
    ...
    private static class WiredNotWiredWorldThing {
        @Wire
        EntityWorld worldWired;
        EntityWorld worldNotWired;
        @SkipWire
        EntityWorld worldSet;
    }
