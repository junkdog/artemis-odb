...
public class WorldConfigurationBuilderManagerTest {
	...
	public void should_support_multiple_plugins_with_same_manager_dependencies() {
		...
		final EntityWorld world = new EntityWorld(builder.with(new SharedDependencyPlugin(), new SharedDependencyPluginB()).build());
	...
	public void should_register_managers_by_priority() {
		...
		final EntityWorld world = new EntityWorld(new WorldConfigurationBuilder()
	...
	protected BaseSystem getLastLoadedManager(EntityWorld world) {
