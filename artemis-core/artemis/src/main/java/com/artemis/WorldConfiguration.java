...
public final class WorldConfiguration {
    ...
    private ComponentMapperFactory componentMapperFactory = null;
    ...
    public void setComponentMapperFactory(ComponentMapperFactory componentMapperFactory) {
        this.componentMapperFactory = componentMapperFactory;
    }

    public ComponentMapperFactory getComponentMapperFactory() {
