...
public class JsonWorldSerializationManagerTest {
	...
	public void save_load_entity_references() throws Exception {
		...
		holder.entityId = tags.getEntityId("tag3");
	...
	public void save_load_intbag_entity_references() throws Exception {
		...
		holder.entities.add(tags.getEntityId("tag1"));
		holder.entities.add(tags.getEntityId("tag3"));
	...
	private void setTags() {
		...
		tags.register("tag1", entities.get(0));
		tags.register("tag3", entities.get(2));
	}
